...
# ===== Resume Settings =====
RESUME_TRAINING = True  # If False, always start from scratch
RESUME_FOLDER = "faster_rcnn_orpn_r50_fpn_1x_dota10_20250811_111928"  # Folder name under work_dirs

# ===== Stability & Safety =====
os.environ.setdefault("CUDA_VISIBLE_DEVICES", "0")  # Use only the first GPU
...
# If you want to use torchrun for single GPU, uncomment below:
# cmd = [
